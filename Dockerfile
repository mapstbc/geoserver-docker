...
COPY geonode-geoserver-ext-2.10-SNAPSHOT.jar /usr/local/tomcat/webapps/geoserver/WEB-INFb/lib/geonode-geoserver-ext-2.10-SNAPSHOT.jar
COPY gt-process-16-20170926.110419-897.jar /usr/local/tomcat/webapps/geoserver/WEB-INFb/lib/gt-process-16-20170926.110419-897.jar
